    ...
    return _then(_value.copyWith(
      ...
      hizbNumber: null == hizbNumber
          ...
          : hizbNumber // ignore: cast_nullable_to_non_nullable
              as int,
      rubElHizbNumber: null == rubElHizbNumber
...
class _$TafsirImpl extends _Tafsir {
  ...
  @override
  String toString() {
    return 'Tafsir(id: $id, verseId: $verseId, languageId: $languageId, text: $text, languageName: $languageName, resourceName: $resourceName, verseKey: $verseKey, chapterId: $chapterId, verseNumber: $verseNumber, juzNumber: $juzNumber, hizbNumber: $hizbNumber, rubElHizbNumber: $rubElHizbNumber, pageNumber: $pageNumber)';
  }
