...
_$JuzImpl _$$JuzImplFromJson(Map<String, dynamic> json) => _$JuzImpl(
      ...
      verseMapping: json['verse_mapping'] as Object,
    );
...
_$VerseMappingImpl _$$VerseMappingImplFromJson(Map<String, dynamic> json) =>
    _$VerseMappingImpl(
      key1: json['1'] as String,
      key2: json['2'] as String,
    );

Map<String, dynamic> _$$VerseMappingImplToJson(_$VerseMappingImpl instance) =>
    <String, dynamic>{
      '1': instance.key1,
      '2': instance.key2,
    };
