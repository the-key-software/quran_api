    ...
    return _then(_value.copyWith(
      ...
      versesCount: null == versesCount
          ...
          : versesCount // ignore: cast_nullable_to_non_nullable
              as int,
      verseMapping: null == verseMapping ? _value.verseMapping : verseMapping,
    ) as $Val);
  }
}
...
abstract class _Juz extends Juz {
  const factory _Juz(
          ...
          @JsonKey(name: 'verse_mapping') required final Object verseMapping}) =
      _$JuzImpl;
...
/// @nodoc
@JsonSerializable()
class _$VerseMappingImpl extends _VerseMapping {
  ...
  @override
  String toString() {
    return 'VerseMapping(key1: $key1, key2: $key2)';
  }
...
abstract class _VerseMapping extends VerseMapping {
  const factory _VerseMapping(
      {@JsonKey(name: '1') required final String key1,
      @JsonKey(name: '2') required final String key2}) = _$VerseMappingImpl;
  const _VerseMapping._() : super._();
