...
mixin _$ChapterReciters {
  ...
  double get filesSize => throw _privateConstructorUsedError;
...
abstract class $ChapterRecitersCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'files_size') double filesSize});
}
...
abstract class _ChapterReciters extends ChapterReciters {
  const factory _ChapterReciters(
          ...
          @JsonKey(name: 'files_size') required final double filesSize}) =
